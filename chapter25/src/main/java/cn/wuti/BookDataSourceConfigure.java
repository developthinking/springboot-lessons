...
@EnableJpaRepositories(
        ...
        basePackages = {"cn.wuti.chapter25.book"}//设置书籍数据源所应用到的包
)
public class BookDataSourceConfigure {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBook (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages(new String[]{ "cn.wuti.chapter25.book" }) //设置应用bookDataSource的基础包名
